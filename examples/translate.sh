...
python3 ../ds2ds.py --to_lang Czech --to_lang_code cs --from_lang English --from_lang_code en \
    --models translategemma:12b translategemma:12b translategemma:12b qwen3:14b \
