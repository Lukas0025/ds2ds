...
- `--to_lang_code` - Target language code for translation - for translategemma (default: None)
- `--from_lang` - Source language for translation - for translategemma (default: None)
- `--from_lang_code` - Source language code for translation - for translategemma (default: None)
